...
class OnlineCourseManagePage(BaseAction):
    ...
    # 在线课程管理
    online_course_manage_btn = By.CSS_SELECTOR, "li.jw - cursor - cursor: nth - child(3)"
    ...
    # 最近一周,最近一个月筛选按钮
    last_week_btn = By.XPATH, "/html/body/div[4]/div[1]/div[1]/button[1]"
    last_month_btn = By.XPATH, "/html/body/div[4]/div[1]/div[1]/button[2]"

    # 状态筛选框
    status_filter = By.CSS_SELECTOR, ".is-focus > input:nth-child(1).is-focus > input:nth-child(1)"
    enable_btn = By.XPATH, "/html/body/div[4]/div[1]/div[1]/ul/li[2]"
    disable_btn = By.XPATH, "/html/body/div[4]/div[1]/div[1]/ul/li[3]"
    ...
    # 资源分类输入框
    resources_sort_input = By.CSS_SELECTOR, ".is-focus > input:nth-child(1)"
    ...
    # 内容类型输入框
    content_type = By.CSS_SELECTOR, ".is-focus > input:nth-child(1)"
    ...
    # 选择视频弹窗的确定按钮
    determine2_btn = By.XPATH, "/html/body/div[6]/div/div[3]/div/button[2]"
    ...
    # 选择5条/页
    first_btn = By.XPATH, "/html/body/div[2]/div[1]/div[1]/ul/li[1]"
