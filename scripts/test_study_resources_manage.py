...
class TestStudyResourcesCRUD:
    ...
    def test_video_library_query(self):
        self.study.click_resources_btn()
    ...
    def test_modify_resources_info(self):
        ...
        self.study.click_edit_resources_name_btn()
        # self.study.click_resources_name_input()
        ...
        # self.study.clear(self.study.edit_resources_name_input)
        self.study.click_edit_resources_name_btn()
